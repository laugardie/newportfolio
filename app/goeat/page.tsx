    ...
    <div className="relative">
      ...
      <SectionSm className="relative pt-24">
        ...
        <Paragraph>
          ...
          was elected as a finalist and earned the privilege of being showcased
          at Madrid{"'"}s{" "}
          <a
          ...
          . The entire project spanned a period of 10 days, with 5 dedicated to
          UX research and design, and the remaining 5 focused on bringing the UI
          to life.
        </Paragraph>
        <H1>The problem</H1>
        <Paragraph>
          Tourism is one of the world biggest economic drivers. During 2018, it
          grew 6%, reaching 1400 million travelers worldwide, according to the
        ...
        <Paragraph>
          ...
          gap. Goeat empowers travelers to effortlessly discover and explore the
          traditional dishes of their chosen destinations, while also providing
          personalised recommendations for nearby restaurants where these
          culinary delights can be savoured.
        </Paragraph>
      </SectionSm>
      ...
      <SectionSm className="relative">
        ...
        <Paragraph>
          ...
          and a survey garnered a remarkable 101 responses, enabling me to gain
        ...
        <Quote>
          When you venture to a destination with a vastly different culture, the
          overwhelming variety of options leaves you clueless about what to try.
        </Quote>
        <Paragraph>
        ...
        <Paragraph>
          ...
          savor every moment and ensure that no hidden gems are missed, leaving
          no room for regrets once she returns home.
        </Paragraph>
        ...
        <BulletedList>
          ...
          <BulletedListItem>
            <b>Language barriers and menu comprehension:</b> Upon arriving at a
            restaurant, Irene is confronted with menus in unfamiliar languages.
            This language barrier poses a significant hurdle, making it
            difficult for her to comprehend the offerings and make informed
            choices.
          </BulletedListItem>
          <BulletedListItem>
            <b>Uncertainty surrounding ingredients and dishes:</b> With limited
            knowledge of local ingredients and dishes, Irene faces the dilemma
            of not knowing what to order. This uncertainty can lead to ordering
            blindly.
          </BulletedListItem>
          <BulletedListItem>
          ...
          <BulletedListItem>
            <b>Unpleasant surprises and disappointment:</b> Unfortunately, Irene
            occasionally encounters food with ingredients she dislikes, leading
            to frustration. This disappointment tarnishes the joy she seeks in
            savoring traditional cuisine.
          </BulletedListItem>
        </BulletedList>
        <Paragraph>
          By understanding and addressing these pain points, our tool strives to
          enhance Irene{"'"}s journey, offering a streamlined solution that
          ...
          dishes, and ensures a more enjoyable and fulfilling dining experience.
        </Paragraph>
        ...
        <Paragraph>
          To guide this creative exploration, I posed the question:How might we
          help Irene fully enjoy the tantalizing gastronomy of her destination
          during her trip? This powerful inquiry propelled the ideation process,
          leading to two dynamic rounds of brainstorming.
        </Paragraph>
        <Paragraph>
          With a wealth of innovative ideas at hand, I then employed the MOSCOW
          method to prioritize features for our Minimum Viable Product (MVP).
          Here are the standout features that made the cut.
        </Paragraph>
        <NumberedList>
          <NumberedListItem>
          ...
          <NumberedListItem>
            ...
            food options that shouldn{"'"}t be missed, allowing Irene to embark
            on a sensory journey through local flavors.
          </NumberedListItem>
          <NumberedListItem>
            <b>Audio Pronunciation of Dish Names:</b> Understanding the
            importance of language comprehension, we provide audio
            pronunciations of dish names, enabling Irene to confidently navigate
            menus and communicate her culinary desires.
          </NumberedListItem>
          <NumberedListItem>
            <b>Audio Pronunciation of Dish Names:</b> Understanding the
            importance of language comprehension, we provide audio
          ...
          <NumberedListItem>
            <b>Ingredients and Allergen Information:</b> To cater to Irene{"'"}s
            specific dietary needs and preferences, our app provides
            comprehensive information on ingredients and allergens, allowing her
            to make well-informed decisions and avoid any unwanted surprises.
          </NumberedListItem>
        </NumberedList>
        <Paragraph>
        ...
        <Paragraph>
          ...
          individuals. Their insights played a pivotal role in shaping the site
          map for our app, aligning it with the features of our Minimum Viable
          Product (MVP).
        </Paragraph>
        <Image
        ...
        <H1>User Flow</H1>
        <Paragraph>
          Before diving into the prototype{"'"}s design, I meticulously crafted
          a comprehensive user flow to chart the user{"'"}s journey through
          Goeat.
        </Paragraph>
        <H1>Prototype and Iterate: Enhancing User Experience</H1>
        <H2>Low Fidelity</H2>
        <Paragraph>
          With the information architecture and user flow in mind, I embarked on
          creating the initial Low Fidelity version of the app, utilizing pen
          and paper to sketch out the design. This early-stage prototype allowed
          me to explore the visual and interactive elements of the app while
          keeping the focus on functionality.
        </Paragraph>
        <Image
        ...
        <BulletedList>
          <BulletedListItem>
            ...
            search for dishes from a specific city when the app already provided
            geo-localization information.
          </BulletedListItem>
          <BulletedListItem>
          ...
          <BulletedListItem>
            ...
            involve refining the navigation and providing clear instructions for
        ...
        <Paragraph>
          ...
          embarked on iterating and refining the design using Sketch, resulting
          in the Mid Fidelity version of the app. This phase allowed me to add
          more visual details and further develop the user interface.
        </Paragraph>
      </SectionSm>
      ...
      <SectionSm>
        ...
        <Paragraph className="mb-6">
          Through this testing phase, valuable feedback emerged, guiding further
          refinements:
        </Paragraph>
        <BulletedList>
          <BulletedListItem>
          ...
          <BulletedListItem>
            All participants (100%) expressed a strong desire for a shortcut to
            their points card from the tab bar.
          </BulletedListItem>
        </BulletedList>
        <H2>High Fidelity</H2>
        <Paragraph>
          ...
          addressing pain points, enhancing visibility, and introducing missing
          features, we have taken significant strides towards creating a
          seamless and delightful gastronomic companion.
        </Paragraph>
      </SectionSm>
      <SectionXl className="mb-6">
        <Image
      ...
      <SectionSm>
        ...
        <Paragraph>
          ...
          moodboard. Carefully curating a collection of images that encapsulated
          the desired brand attributes—authentic, inspiring, and adventurous—I
          embarked on a visual exploration to capture the essence of the app.
        </Paragraph>
      </SectionSm>
      ...
      <SectionSm>
        <Paragraph>
          ...
          the desired brand personality and resonated with the target audience.
          This confirmation serves as a solid foundation for the subsequent
          development of the app{"'"}s branding elements.
        </Paragraph>
      </SectionSm>
      <SectionMd className="mb-6">
        <Image
      ...
      <SectionSm>
        ...
        <Paragraph>
          ...
          as the primary typeface. Created by <i>Lukasz Dziedzic</i>, Lato is a
          warm and friendly Sans Serif font. Its semi-rounded details strike the
          perfect balance between formality and approachability, enhancing the
      ...
      <SectionSm>
        <Paragraph>
          <b>Colors:</b> Goeat{"'"}s main colors are red –<i>Amaranth</i>, deep
          blue –<i>Firefly</i> and grey –<i>Seashell</i>. Red is the primary
          color.
        </Paragraph>
      </SectionSm>
      <SectionMd>
      ...
      <SectionSm>
        <Paragraph>
          ...
          carefully curated to align with the brand{"'"}s vision, enhancing the
          user experience and reinforcing the desired emotional connection.
        </Paragraph>
      </SectionSm>
      ...
      <SectionSm>
        <Paragraph>
          <b>Layout and Composition:</b>s Consistency in layout and composition
          is key to establishing a visually cohesive experience.
        </Paragraph>
      </SectionSm>
      <SectionMd className="mb-10">
        <Image
      ...
      <SectionSm>
        ...
        <Paragraph>
          Using Flinto, the prototype has been transformed into an engaging and
          immersive experience, showcasing the seamless flow of user
          interactions.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          ...
          from discovering the restaurant to immersing themselves in the dining
          experience. As the user arrives at the restaurant, they receive a
          notification prompting them to access the restaurant{"'"}s menu.
        </Paragraph>
        <Paragraph>
          With a simple tap, the user effortlessly accesses the menu, revealing
          a visually enticing display of culinary delights. They navigate
          through the menu, exploring different sections and dishes with ease.
          When the user selects a dessert, they are presented with additional
          information, such as ingredients and a captivating description.
        </Paragraph>
        <div className="max-w-xs mx-auto mb-10">
          <Image
        ...
        <Paragraph>
          In this third video, we witness the user{"'"}s return to the app, this
          time to take advantage of the discount points feature and further
          engage with their dining experiences.
        </Paragraph>
        <div className="max-w-xs mx-auto mb-10">
          <Image
        ...
        <Paragraph>
          ...
          discover and download the app, while also showcasing its features and
          the glowing comments from satisfied users.
        </Paragraph>
        <Image
        ...
        <BulletedList>
          ...
          <BulletedListItem>
            ...
            friends on Goeat opens up new social dimensions to the app. Testing
            this feature will empower users to discover and share culinary
            experiences with their social circle.
          </BulletedListItem>
          <BulletedListItem>
            <b>Gastronomy Tours with Locals:</b> Introducing gastronomy tours
            led by locals immerses users in authentic culinary experiences while
            traveling.
          </BulletedListItem>
          <BulletedListItem>
