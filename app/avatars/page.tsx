    ...
    <div className="relative">
      ...
      <article>
        <SectionSm className="relative pt-24">
          ...
          <Paragraph>
            To begin, I let my creativity flow as I sketched various faces
            adorned with distinct hairstyles, clothes, and facial expressions on
            separate sheets of paper. Utilizing a head template, I ensured that
            all the body parts shared a uniform size. Take a look at some
            examples in the images below for a glimpse into the process.
          </Paragraph>
        </SectionSm>
        <SectionMd>
        ...
        <SectionSm>
          <Paragraph>
            Once I felt satisfied with the diverse range of variations, I
            captured a photograph of all the doodles and then proceeded to
            vectorise them in Illustrator, meticulously crafting individual body
            parts.
          </Paragraph>
          <Paragraph>
        ...
        <SectionSm>
          <Paragraph>
            As a final step, I transferred these elements into Figma, enabling
            the creation of different variants. Now, you have the freedom to
            combine and assemble various body parts as you please, crafting your
            very own unique avatar.
          </Paragraph>
          <Image
      ...
      <NextBack href={"/lexicon"} next={"Lexicon"} />
    </div>
  );
}
