    ...
    <div className="relative">
      ...
      <SectionSm className="relative pt-24">
        ...
        <Paragraph>
          ...
          the modal or immerse themselves in a distraction-free full-screen
          mode. Theatre Mode amplifies the user experience, enabling seamless
          content exploration and dynamic interaction.
        </Paragraph>
        <H1>The problem</H1>
        ...
        <NumberedList>
          <NumberedListItem>
            <b>Navigating content challenges</b>: With Theatre Mode, there{"'"}s
            no need to download documents to access them. This eliminates the
            hassle of downloading, saving, and managing files, providing users
            with immediate access to the information they need.
          </NumberedListItem>
          <NumberedListItem>
            <b>Loss of time</b>: Theatre Mode creates a unified space where
            users can seamlessly interact with the attached information. Instead
            of navigating away to view or comment on documents, users can engage
            directly within the same interface, streamlining their workflow and
            enhancing their productivity.
          </NumberedListItem>
        </NumberedList>
        <H1>The solution</H1>
        <Paragraph>
          Theatre Mode optimizes the user experience. It minimizes disruptions,
          empowers users to engage directly with the content they need, and
          ultimately fosters a more efficient and productive work environment
          within Beezy{"'"}s digital workplace platform.
        </Paragraph>
      </SectionSm>
      <SectionMd>
        <Image
      ...
      <SectionSm>
        ...
        <Paragraph>
          ...
          where users can solely concentrate on the content at hand. It empowers
          users with the option to display or hide comments, ensuring an
          undisturbed and immersive experience tailored to their needs.
        </Paragraph>
      </SectionSm>
      <SectionMd>
        <Image
      ...
      <SectionSm>
        ...
        <Paragraph>
          ...
          horizontal scrolling, and an intuitive hint guides them towards hidden
          elements, ensuring a comprehensive viewing experience. To access these
          elements, users can either scroll horizontally through the thumbnails
          or conveniently tab through them, effortlessly transitioning from one
      ...
      <SectionSm>
        ...
        <Paragraph>
          The right panel enables a dynamic side-by-side display of content and
          comments. Users can effortlessly engage with comments while
          simultaneously viewing the content, fostering real-time collaboration
          and offering insight into ongoing discussions.
        </Paragraph>
      </SectionSm>
      <SectionMd>
        <Image
      ...
      <SectionSm>
        ...
        <Paragraph>
          ...
          toggle between different types of content, giving you the flexibility
          to engage with your attachments just the way you want. No more
          switching windows or hunting for files. It{"'"}s all right there,
          neatly organized for your convenience.
        </Paragraph>
        <Paragraph>
          Check out the image below to see how we{"'"}ve displayed various types
          of content.
        </Paragraph>
      </SectionSm>
      <SectionXl>
      ...
      <SectionSm>
        <Paragraph>
          ...
          every second saved, this innovation aligns with Beezy{"'"}s commitment
          to enhancing productivity and fostering seamless communication. As we
          step into an era of ever-evolving work dynamics, Theatre Mode stands
