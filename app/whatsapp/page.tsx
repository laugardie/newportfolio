    ...
    <div className="relative">
      ...
      <SectionSm className="relative pt-24">
        <aside className="absolute left-full pl-24">
          <dl className="mt-[152px]">
            ...
            <MetaProps tag="Industry" description="Feature Design" />
        ...
        <Paragraph>
          ...
          and getting stuck in the endless loop of deciding on a date? Are those
          group chats flooded with scattered information and options that often
          get lost? If you{"'"}ve nodded in agreement, then it{"'"}s time to
          introduce the solution: <i>WhatsApp Polls</i>.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph className="mb-6">
          ...
          primary platform for countless users to collectively reach decisions.
          Whether it{"'"}s pinpointing a plan{"'"}s date, choosing the next
          vacation destination, or selecting the perfect birthday gift, the app
          witnesses a myriad of group decisions. However, within this context, a
          host of challenges emerge:
        </Paragraph>
        <BulletedList>
          <BulletedListItem>
          ...
          <BulletedListItem>
            ...
            contributes to confusion as previous information becomes susceptible
      ...
      <SectionSm>
        ...
        <Paragraph className="mb-6">
          ...
          {"'"}s branding. Subsequently, we conducted a Usability Test involving
          5 users, which led to iterative improvements resulting in a second
          version. The key insights garnered from this testing phase were as
          follows:
        </Paragraph>
        <BulletedList>
          <BulletedListItem>
          ...
          <BulletedListItem>
            3 out of 5 users initially tried to find the poll feature within the{" "}
            {'"'}more{'"'} menu (three dots on the top right corner), suggesting
            a need for improved visibility.
          </BulletedListItem>
          <BulletedListItem>
            The desire to preview existing votes before casting their own was a
            common request among users.
          </BulletedListItem>
          <BulletedListItem>
            Users expressed the wish to access and manage their previous polls,
            leading to the creation of a dedicated screen for viewing, editing,
            and closing polls.
          </BulletedListItem>
          <BulletedListItem>
            Creating multi-selection polls initially posed challenges for users.
            This was addressed by implementing a switch button on the poll
            configuration screen, allowing users to toggle between single and
        ...
        <Paragraph>
          ...
          design and facilitating iterative improvements for the second version.
        </Paragraph>
      </SectionSm>
      <SectionMd>
        <figure>
          ...
          />
          <Caption>
            Version 1 vs Version 2 of feature after performing a Usability test.
          </Caption>
        </figure>
      </SectionMd>
      <SectionSm>
        ...
        <Paragraph>
          ...
          foundational step that played a pivotal role in shaping our strategy.
          Through careful analysis, we delineated how the design of this
          innovative feature would not only enhance customer experience but also
          deliver value to the business. This strategic blueprint also
          encompassed the identification of the tools that would guide us on
          this path, empowering us to navigate the journey efficiently and
      ...
      <SectionSm>
        ...
        <Paragraph>
          ...
          feature into their applications. This discovery illuminated a gap for
          WhatsApp, as it presently offers fewer functionalities to its user
          base. Recognizing this, we identified the addition of the poll feature
          as an opportunity to both entice new users and enhance overall user
          satisfaction.
        </Paragraph>
        <Paragraph>
      ...
      <SectionSm>
        ...
        <Paragraph>
          ...
          existing app, we embarked on a research journey delving into WhatsApp
        ...
        <Paragraph>
          The design is simple and easy to use, so Whatsapp doesn{"’"}t need to
          explain any of its features to its users.
        </Paragraph>
        <Paragraph>
        ...
        <Paragraph>
          Their primary color is green –<i>Whatsapp green</i>– which they use to
          evoke a friendly and calm feeling. They also use a different set of
          colors to complement it but with caution.
        </Paragraph>
        <Image
        ...
        <BulletedList>
          <BulletedListItem>
            When a user enters a group chat, they can access additional options
            by tapping the top right icon, and there they will find the {'"'}
      ...
      <SectionSm>
        <BulletedList>
          <BulletedListItem>
            Once the poll is published, the user can vote and edit their choice
            by tapping on a different option.
          </BulletedListItem>
          <BulletedListItem>
            The user can see a list of polls inside {"“"}Group{"’"}s polls{"”"}{" "}
            [5], active ones with a white background and inactive ones with a
            grey background.
          </BulletedListItem>
        </BulletedList>
      </SectionSm>
      ...
      <SectionSm>
        <Paragraph>
          Presented below is the latest iteration of the prototype, encompassing
          the complete user journey—from the creation of a poll, selection of an
          option, to the comprehensive overview of the poll{"'"}s list and
          status.
        </Paragraph>
        ...
        <Paragraph>
          ...
          to conduct another round of usability testing involving 5 individuals.
          This iterative approach allows us to fine-tune the design, ensuring
          that our product evolves in harmony with user needs and expectations.
        </Paragraph>
        <Paragraph className="mb-6">
        ...
        <BulletedList>
          ...
          <BulletedListItem>
            <b>Expiry Date and Reminders:</b> Introducing the ability to set an
            expiration date for polls and sending reminders to participants who
            have yet to vote.
          </BulletedListItem>
          <BulletedListItem>
