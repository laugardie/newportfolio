...
const ProjectCover = ({ href, src, alt, name, role, year }: ProjectCoverProps) => (
  <Link className="cursor-pointer" href={href}>
    <div className="w-full overflow-hidden ease-in-out duration-200 rounded-lg border border-border">
      <Image
        src={src}
        width={450}
        height={595}
        alt={alt}
        className="w-full h-auto block ease-in-out duration-200 hover:scale-110"
      />
    </div>
